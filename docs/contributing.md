...
6. If the bug is on the Chromium side, create a corresponding crbug.com issu, label the GitHub issue with the `upstream` label, and post a link to crbug.com in the comments.
