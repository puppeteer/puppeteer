...
The [newest Chromium package](https://pkgs.alpinelinux.org/package/edge/community/x86_64/chromium) supported on Alpine is 76, which was corresponding to [Puppeteer v1.17.0](https://github.com/GoogleChrome/puppeteer/releases/tag/v1.17.0).
