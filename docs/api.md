...
- returns: <[Promise]<[Array]<[JSHandle]>>>

The method returns an array which properties are JSHandle instances to the property values.
...
- returns: <[Object]<[string], [JSHandle]>>

The method returns an object which properties are JSHandle instances to the property values.
