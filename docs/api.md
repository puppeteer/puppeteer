...
- `options` <[Object]> Options object which might have the following properties:
  ...
  - `headerTemplate` <[string]> HTML template for the print header. Should be valid HTML markup with following CSS classes used to inject printing values into them:
