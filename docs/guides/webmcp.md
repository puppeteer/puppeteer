...
WebMCP is an experimental API and is subject to change. It is currently only supported in Chrome 151+ and requires specific flag to be enabled.
...
1.  **Chrome 151+**: The browser must support the WebMCP CDP domain.
