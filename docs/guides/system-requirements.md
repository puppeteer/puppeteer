...
- Chrome for Testing browser system requirements:
  ...
  - [Debian/Ubuntu Linux](https://support.google.com/chrome/a/answer/7100626?hl=en#:~:text=10.15%20or%20later-,Linux,-To%20use%20Chrome), x64 and arm64 architectures
  ...
  - [openSUSE/Fedora Linux](https://support.google.com/chrome/a/answer/7100626?hl=en#:~:text=10.15%20or%20later-,Linux,-To%20use%20Chrome), x64 and arm64 architectures
  ...
  - `tar.exe` or Powershell on Windows and `unzip` on MacOS/Linux for unpacking Chrome for Testing binaries, unless the optional [`yauzl`](https://www.npmjs.com/package/yauzl) dependency is installed.

- Firefox browser system requirements:
  - https://www.mozilla.org/en-US/firefox/system-requirements/
  - The `xz` (unless the optional `xz-decompress` dependency is installed) or `bzip2` utilities are required to unpack Firefox versions for Linux.
