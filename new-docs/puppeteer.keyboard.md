...
Keyboard provides an api for managing a virtual keyboard. The high level api is , which takes raw characters and generates proper keydown, keypress/input, and keyup events on your page.
