...
class DisposablePromise {
  constructor(promise, disposeCallback) {
...
class Helper {
   ...
   * @return {!Promise}
   */
  static waitForEvent(emitter, eventName, predicate, timeout, abortSignal) {
    ...
    return Promise.race([promise, abortSignal.promise()]).then(r => {
      cleanup();
      return r;
    }, e => {
      cleanup();
