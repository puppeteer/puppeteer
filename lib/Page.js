...
class Page extends EventEmitter {
  ...
  constructor(client, target, frameTree, ignoreHTTPSErrors, screenshotTaskQueue) {
    ...
    this._networkManager = new NetworkManager(client, this);
  ...
  /**
   * @return {!Puppeteer.NetworkManager}
   */
  networkManager() {
  ...
  async waitForNavigation(options = {}) {
    options.timeout = typeof options.timeout === 'number' ? options.timeout : this._defaultNavigationTimeout;
