...
class Page extends EventEmitter {
  ...
  async emulate(options) {
    return Promise.all([
      ...
      this.setNavigator(options.navigator, options.webGLInfo)
    ]);
  }
  ...
  /**
   * @param {!Page.Navigator} navigator
   */
  async setNavigator(navigator,webGLInfo) {
    const needsReload = await this._emulationManager.emulateNavigator(this._client, navigator,webGLInfo);
...
/** @typedef {{vendorSub: String, productSub: String, vendor: String, appCodeName: String, appName: String, appVersion:String}} */
Page.Navigator;
