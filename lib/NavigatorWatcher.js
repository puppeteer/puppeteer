...
class NavigatorWatcher {
  ...
  constructor(frameManager, frame, timeout, options = {}) {
    ...
    this._eventListeners = [
      ...
      helper.addEventListener(this._frameManager, FrameManager.Events.ConnectionClosed, () => {
        console.log('FrameManager.ConnectionClosed detected');
        return this._lifecycleCompleteCallback.bind(this);
      }),
