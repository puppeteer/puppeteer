...
const {VirtualTimeStartPolicy} = require('./VirtualTimeController');
...
class NavigatorWatcher {
  ...
  constructor(frameManager, frame, timeout, options = {}) {
    ...
    if (this._frame._page._virtualTimeController) {
      this._navigationPromise = this._frame._page._virtualTimeController.grantVirtualTimeBudget(timeout, VirtualTimeStartPolicy.WAIT_FOR_NAVIGATION, options.virtualTimeStartedCallback);
    } else {
      let waitUntil = ['load'];
