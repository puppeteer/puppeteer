...
class Browser extends EventEmitter {
  ...
  /**
   * @param {?Protocol.Target.BrowserContextID} contextId
   * @param {string} origin
  ...
  async _overridePermissions(contextId, origin, permissions) {
    ...
    await this._connection.send('Browser.grantPermissions', {origin, browserContextId: contextId || undefined, permissions});
  }

  /**
   * @param {?Protocol.Target.BrowserContextID} contextId
   */
  async _resetPermissionOverrides(contextId) {
    await this._connection.send('Browser.resetPermissions', {browserContextId: contextId || undefined});
  }
...
class BrowserContext extends EventEmitter {
  ...
  async overridePermissions(origin, permissions) {
    await this._browser._overridePermissions(this._id, origin, permissions);
  }

  async resetPermissionOverrides() {
    await this._browser._resetPermissionOverrides(this._id);
  }
