...
class Browser extends EventEmitter {
  ...
  async newPage() {
    ...
    const newPage = await Page.create(client, this._ignoreHTTPSErrors, this._appMode, this._screenshotTaskQueue);
  ...
  _closed() { this.emit(Browser.Events.Closed, 'browser closed');}
