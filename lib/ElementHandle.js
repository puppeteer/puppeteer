...
class ElementHandle extends JSHandle {
  ...
  /**
   * @return {!Promise<?{border: object, content: object, margin: object, padding: object, width: number, height: number}>}
   */
  async boundingBox() {
    ...
    return {
      border: calculatePos(result.model.border),
      content: calculatePos(result.model.content),
      margin: calculatePos(result.model.margin),
      padding: calculatePos(result.model.padding),
