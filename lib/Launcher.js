...
class Launcher {
  ...
  static async launch(options) {
    ...
    assert(chromeExecutable === undefined || helper.isString(chromeExecutable), `Specified "executablePath" option is not of type String.`);
    if (!helper.isString(chromeExecutable)) {
