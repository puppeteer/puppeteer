...
class Worker extends EventEmitter {
   ...
   * @param {function(!Protocol.Runtime.ExceptionDetails)} errorAPICalled
   */
  constructor(client, url, consoleAPICalled, errorAPICalled) {
    super();
    this._client = client;
    this._url = url;
    ...
    this._client.on('Runtime.exceptionThrown', exception => errorAPICalled(exception.exceptionDetails));
  }
