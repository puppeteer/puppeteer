...
class JSCoverage {
  ...
  async start(options = {}) {
    ...
    this._ignoreAnonymousScripts = options.ignoreAnonymousScripts === undefined ? true : !!options.ignoreAnonymousScripts;
    this._enabled = true;
  ...
  async _onScriptParsed(event) {
    ...
    if (event.url === '__puppeteer_evaluation_script__')
      return;
    // Ignore other anonymous scripts unless the ignoreAnonymousScripts option is false.
    if (!event.url && this._ignoreAnonymousScripts)
      return;
    try {
