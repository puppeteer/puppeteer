...
class NetworkManager extends EventEmitter {
  ...
  /**
   * @param {!Map<string, string>|Object} extraHTTPHeaders
   * @return {!Promise}
   */
  async setExtraHTTPHeaders(extraHTTPHeaders) {
    if (extraHTTPHeaders instanceof Map)
      this._extraHTTPHeaders = extraHTTPHeaders;
    else
      this._extraHTTPHeaders = new Map(Object.entries(extraHTTPHeaders));
    const headers = {};
    for (const [k, v] of this._extraHTTPHeaders)
      headers[k] = v;
