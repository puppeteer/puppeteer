...
class BrowserFetcher {
  ...
  async download(revision, progressCallback) {
    ...
    try {
      await downloadFile(url, zipPath, progressCallback, { ca: this._ca });
 ...
 * @return {!Promise}
 */
function downloadFile(url, destinationPath, progressCallback, opt) {
  let fulfill, reject;
...
function httpRequest(url, method, response, opt) {
  /** @type {Object} */
  ...
  if (opt.ca && options.protocol === 'https:')
    options.ca = opt.ca;
