...
class FrameManager extends EventEmitter {
  ...
  _setNetworkManager(networkManager, frameTree) {
  ...
  _onFrameAttached(frameId, parentFrameId) {
    ...
    const frame = new Frame(this._client, parentFrame, frameId, this, this._networkManager);
  ...
  _onFrameNavigated(framePayload) {
    ...
    if (isMainFrame) {
      if (frame) {
        ...
        frame = new Frame(this._client, null, framePayload.id, this, this._networkManager);
      }
...
class Frame {
   ...
   * @param {string} frameId
   */
  constructor(client, parentFrame, frameId, frameManager, networkManager) {
    this._client = client;
  ...
  */
  ...
  async waitForNavigation(options = {}) {
    ...
    const watcher = new NavigatorWatcher(this._frameManager, this, timeout, options);
