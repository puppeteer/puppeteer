...
class Frame {
  ...
  */
  ...
  async waitForNavigation(options = {}) {
    ...
    const watcher = new NavigatorWatcher(this._page.frameManager(), this, timeout, options);

    const responses = new Map();
    const listener = helper.addEventListener(this._page.networkManager(), NetworkManager.Events.Response, response => responses.set(response.url(), response));
