...
class Frame {
  ...
  */
  ...
  _waitForSelectorOrXPath(selectorOrXPath, isXPath, options = {}) {
    ...
    return this.waitForFunction(predicate, {timeout: options.timeout, polling, title: `${isXPath ? 'XPath' : 'selector'} "${selectorOrXPath}"`}, selectorOrXPath, isXPath, waitForVisible, waitForHidden);
