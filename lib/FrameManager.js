...
const {IsolatedWorld} = require('./IsolatedWorld');
...
class Frame {
  ...
  constructor(frameManager, client, parentFrame, frameId) {
    ...
    this._isolatedWorld = new IsolatedWorld(frameManager, this);
  ...
  _addExecutionContext(context) {
    if (context._isDefault)
      this._isolatedWorld._setDefaultContext(context);
  }
  ...
  _removeExecutionContext(context) {
    if (context._isDefault)
      this._isolatedWorld._setDefaultContext(null);
  }
   ...
   */
  async content() {
    return this._isolatedWorld.content();
  }
  ...
  async setContent(html, options = {}) {
    return this._isolatedWorld.setContent(html, options);
  }
  ...
  async click(selector, options) {
    return this._isolatedWorld.click(selector, options);
  }
  ...
  async focus(selector) {
    return this._isolatedWorld.focus(selector);
  }
  ...
  async hover(selector) {
    return this._isolatedWorld.hover(selector);
  }
  ...
  */
  select(selector, ...values){
    return this._isolatedWorld.select(selector, ...values);
  }
   ...
   */
  async tap(selector) {
    return this._isolatedWorld.tap(selector);
  }
  ...
  waitFor(selectorOrFunctionOrTimeout, options = {}, ...args) {
    return this._isolatedWorld.waitFor(selectorOrFunctionOrTimeout, options, ...args);
  }
  ...
  waitForSelector(selector, options) {
    return this._isolatedWorld.waitForSelector(selector, options);
  }
  ...
  waitForXPath(xpath, options) {
    return this._isolatedWorld.waitForXPath(xpath, options);
  }
  ...
  waitForFunction(pageFunction, options = {}, ...args) {
    return this._isolatedWorld.waitForFunction(pageFunction, options, ...args);
  }
   ...
   */
  async title() {
    return this._isolatedWorld.title();
  }
