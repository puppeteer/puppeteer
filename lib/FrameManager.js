...
class FrameManager extends EventEmitter {
  ...
  async _evaluateOnFrame(frame, pageFunction, ...args) {
    return this._evaluateStringOnFrame(frame, helper.evaluationString(pageFunction, ...args));
  }
   ...
   * @return {!Promise<(!Object|undefined)>}
   */
  async _evaluateStringOnFrame(frame, expression) {
...
class Frame {
  ...
  async $(selector, fun, ...args) {
    ...
    return this._frameManager._evaluateStringOnFrame(this, expression);
  }
