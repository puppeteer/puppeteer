...
class FrameManager extends EventEmitter {
  ...
  _onFrameAttached(frameId, parentFrameId) {
    ...
    const frame = new Frame(this._client, parentFrame, frameId, this);
  ...
  _onFrameNavigated(framePayload) {
    ...
    if (isMainFrame) {
      if (frame) {
        ...
        frame = new Frame(this._client, null, framePayload.id, this);
      }
...
class Frame {
   ...
   * @param {string} frameId
   */
  constructor(client, parentFrame, frameId, frameManager) {
    this._client = client;
    ...
    this._networkManager = new NetworkManager(client, frameManager);
