  ...
  */
  ...
  _waitForSelectorOrXPath(selectorOrXPath, isXPath, options = {}) {
    ...
    function predicate(selectorOrXPath, isXPath, waitForVisible, waitForHidden) {
      ...
      if (!node)
        return Promise.resolve(waitForHidden);
      ...
      return new Promise(resolve => {
        ...
        const callback = entries => {
          const isVisible = entries[0].isIntersecting && style && style.visibility !== 'hidden' && style.display !== 'none';
          const success = (waitForVisible === isVisible || waitForHidden === !isVisible);
          resolve(success ? node : null);
