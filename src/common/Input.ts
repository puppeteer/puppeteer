 ...
 * The high level api is {@link Keyboard.type | Keyboard.type},
 * which takes raw characters and generates proper keydown, keypress/input,
 * and keyup events on your page.
 *
 * @remarks
 * For finer control, you can use {@link Keyboard.down | Keyboard.down},
 * {@link Keyboard.up | Keyboard.up}, and
 * {@link Keyboard.sendCharacter | Keyboard.sendCharacter}
...
export class Keyboard {
   ...
   * To release the modifier key, use {@link Keyboard.up | Keyboard.up}.
   *
   * After the key is pressed once, subsequent calls to
   * {@link Keyboard.down | Keyboard.down} will have
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/KeyboardEvent/repeat | repeat}
   * set to true. To release the key, use
   * {@link Keyboard.up | Keyboard.up}.
   *
   * Modifier keys DO influence {@link Keyboard.down | Keyboard.down}.
   ...
   * use {@link Keyboard.press | Keyboard.press}.
   *
  ...
  /**
   * Shortcut for {@link Keyboard.down | Keyboard.down}
   * and {@link Keyboard.up | Keyboard.up}.
   *
   * @remarks
   * If `key` is a single character and no modifier keys besides `Shift`
   * are being held down, a `keypress`/`input` event will also generated.
   * The `text` option can be specified to force an input event to be generated.
   *
   * Modifier keys DO effect {@link Keyboard.press | Keyboard.press}.
   * Holding down `Shift` will type the text in upper case.
   *
   * @param key - Name of key to press, such as `ArrowLeft`.
   * See {@link KeyInput | KeyInput}
