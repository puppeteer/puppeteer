...
export class Coverage {
   ...
   * @param options.resetOnNavigation - Whether to reset coverage on every navigation. @defaultValue true.
   * @param options.reportAnonymousScripts - Whether anonymous scripts generated by the page should be reported. @defaultValue false.
