...
File chooser can be handled with `page.handleFileChooser` command.
       ...
       */
      export type handleFileChooserParameters = {
      ...
      export type handleFileChooserReturnValue = {
      }
  }
...
unsubscribes current runtime agent from Runtime.bindingCalled notifications.
  ...
  export interface CommandParameters {
    ...
    "Page.handleFileChooser": Page.handleFileChooserParameters;
  ...
  export interface CommandReturnValues {
    ...
    "Page.handleFileChooser": Page.handleFileChooserReturnValue;
