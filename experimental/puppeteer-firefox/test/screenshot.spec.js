...
module.exports.addTests = function({testRunner, expect, product}) {
  ...
  describe('Page.screenshot', function() {
    ...
    (FFOX ? xit : it)('should allow transparency', async({page, server}) => {
      await page.setViewport({ width: 100, height: 100 });
      await page.goto(server.EMPTY_PAGE);
      const screenshot = await page.screenshot({omitBackground: true});
      expect(screenshot).toBeGolden('transparent.png');
    });
    (FFOX ? xit : it)('should render white background on jpeg file', async({page, server}) => {
      await page.setViewport({ width: 100, height: 100 });
      await page.goto(server.EMPTY_PAGE);
    ...
    it('should return base64', async({page, server}) => {
      ...
      expect(Buffer.isBuffer(screenshot)).toBe(false);
  ...
  describe('ElementHandle.screenshot', function() {
    ...
    (CHROME ? xit : it)('should not hang with zero width/height element', async({page, server}) => {
