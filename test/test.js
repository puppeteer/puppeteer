...
describe('Puppeteer', function() {
  describe('Puppeteer.launch', function() {
    it('should support ignoreHTTPSErrors option', async function() {
    ...
    it('should reject all promises when browser is closed', async function() {
    ...
    it('should reject if executable path is invalid', async function() {
      let waitError = null;
    ...
    it('userDataDir option', async function() {
    ...
    it('userDataDir argument', async function() {
      const userDataDir = fs.mkdtempSync(path.join(__dirname, 'test-user-data-dir'));
    ...
    it('userDataDir option should restore state', async function() {
      const userDataDir = fs.mkdtempSync(path.join(__dirname, 'test-user-data-dir'));
      const options = Object.assign({userDataDir}, defaultBrowserOptions);
      const browser = await puppeteer.launch(options);
      const page = await browser.newPage();
    ...
    xit('userDataDir option should restore cookies', async function() {
      const userDataDir = fs.mkdtempSync(path.join(__dirname, 'test-user-data-dir'));
      const options = Object.assign({userDataDir}, defaultBrowserOptions);
      const browser = await puppeteer.launch(options);
      const page = await browser.newPage();
    ...
    xit('headless should be able to read cookies written by headful', async function() {
      const userDataDir = fs.mkdtempSync(path.join(__dirname, 'test-user-data-dir'));
      const options = Object.assign({userDataDir}, defaultBrowserOptions);
  ...
  describe('Puppeteer.connect', function() {
    it('should be able to connect multiple times to the same browser', async function() {
    ...
    it('should be able to reconnect to a disconnected browser', async function() {
      const originalBrowser = await puppeteer.launch(defaultBrowserOptions);
...
describe('Page', function() {
  ...
  describe('Browser.version', function() {
    it('should return whether we are in headless', async function() {
  ...
  describe('Browser.process', function() {
    it('should return child_process instance', async function() {
  ...
  describe('Browser.Events.disconnected', function() {
    it('should emitted when: browser gets closed, disconnected or underlying websocket gets closed', async function() {
      const originalBrowser = await puppeteer.launch(defaultBrowserOptions);
      const browserWSEndpoint = originalBrowser.wsEndpoint();
  ...
  describe('Page.close', function() {
    it('should reject all promises when page is closed', async function() {
  ...
  describe('Page.Events.error', function() {
    it('should throw when page crashes', async function() {
      let error = null;
  ...
  describe('Page.evaluate', function() {
    ...
    it('should work right after framenavigated', async function() {
    ...
    it('should work from-inside an exposed function', async function() {
    ...
    it('should reject promise with exception', async function() {
      let error = null;
    ...
    it('should accept "undefined" as one of multiple parameters', async function() {
      const result = await page.evaluate((a, b) => Object.is(a, undefined) && Object.is(b, 'foo'), undefined, 'foo');
      expect(result).toBe(true);
    });
    it('should fail for window object', async function() {
    ...
    it('should accept a string with semi colons', async function() {
      const result = await page.evaluate('1 + 5;');
      expect(result).toBe(6);
    });
    it('should accept a string with comments', async function() {
      const result = await page.evaluate('2 + 5;\n// do some math!');
      expect(result).toBe(7);
    });
    it('should accept element handle as an argument', async function() {
      await page.setContent('<section>42</section>');
      const element = await page.$('section');
      const text = await page.evaluate(e => e.textContent, element);
      expect(text).toBe('42');
    });
    it('should throw if underlying element was disposed', async function() {
    ...
    it('should throw if elementHandles are from other frames', async function() {
      const FrameUtils = require('./frame-utils');
    ...
    it('should accept object handle as an argument', async function() {
    ...
    it('should accept object handle to primitive types', async function() {
  ...
  describe('Page.setOfflineMode', function() {
    ...
    it('should emulate navigator.onLine', async function() {
  ...
  describe('ExecutionContext.queryObjects', function() {
    ...
    it('should fail for disposed handles', async function() {
    ...
    it('should fail primitive values as prototypes', async function() {
  ...
  describe('JSHandle.jsonValue', function() {
    ...
    it('should not work with dates', async function() {
      const dateHandle = await page.evaluateHandle(() => new Date('2017-09-26T00:00:00.000Z'));
      const json = await dateHandle.jsonValue();
      expect(json).toEqual({});
    });
    it('should throw for circular objects', async function() {
      const windowHandle = await page.evaluateHandle('window');
      let error = null;
  ...
  describe('JSHandle.getProperties', function() {
    ...
    it('should return even non-own properties', async function() {
      const aHandle = await page.evaluateHandle(() => {
        class A {
          constructor() {
            this.a = '1';
  ...
  describe('JSHandle.asElement', function() {
    ...
    it('should return null for non-elements', async function() {
      const aHandle = await page.evaluateHandle(() => 2);
      const element = aHandle.asElement();
      expect(element).toBeFalsy();
    });
    it('should return ElementHandle for TextNodes', async function() {
  ...
  describe('JSHandle.toString', function() {
    it('should work for primitives', async function() {
      const numberHandle = await page.evaluateHandle(() => 2);
      expect(numberHandle.toString()).toBe('JSHandle:2');
      const stringHandle = await page.evaluateHandle(() => 'a');
      expect(stringHandle.toString()).toBe('JSHandle:a');
    });
    it('should work for complicated objects', async function() {
  ...
  describe('Frame.evaluate', function() {
    const FrameUtils = require('./frame-utils');
    it('should have different execution contexts', async function() {
      await page.goto(EMPTY_PAGE);
      await FrameUtils.attachFrame(page, 'frame1', EMPTY_PAGE);
      expect(page.frames().length).toBe(2);
    ...
    it('should execute after cross-site navigation', async function() {
      await page.goto(EMPTY_PAGE);
  ...
  describe('Frame.waitForFunction', function() {
    ...
    it('should poll on interval', async function() {
      let success = false;
    ...
    it('should poll on mutation', async function() {
      let success = false;
    ...
    it('should poll on raf', async function() {
      const watchdog = page.waitForFunction(() => window.__FOO === 'hit', {polling: 'raf'});
      await page.evaluate(() => window.__FOO = 'hit');
      await watchdog;
    });
    it('should throw on bad polling value', async function() {
      let error = null;
      try {
    ...
    it('should throw negative polling interval', async function() {
      let error = null;
      try {
  ...
  describe('Frame.waitForSelector', function() {
    ...
    it('should immediately resolve promise if node exists', async function() {
      await page.goto(EMPTY_PAGE);
    ...
    it('should resolve promise when node is added', async function() {
      await page.goto(EMPTY_PAGE);
      const frame = page.mainFrame();
      let added = false;
    ...
    it('should work when node is added through innerHTML', async function() {
      await page.goto(EMPTY_PAGE);
    ...
    it('Page.waitForSelector is shortcut for main frame', async function() {
      await page.goto(EMPTY_PAGE);
      await FrameUtils.attachFrame(page, 'frame1', EMPTY_PAGE);
    ...
    it('should run in specified frame', async function() {
      await FrameUtils.attachFrame(page, 'frame1', EMPTY_PAGE);
    ...
    it('should throw if evaluation failed', async function() {
    ...
    it('should throw when frame is detached', async function() {
      await FrameUtils.attachFrame(page, 'frame1', EMPTY_PAGE);
    ...
    it('should survive cross-process navigation', async function() {
      let boxFound = false;
    ...
    it('should wait for visible', async function() {
      let divFound = false;
    ...
    it('should wait for visible recursively', async function() {
    ...
    it('hidden should wait for visibility: hidden', async function() {
      let divHidden = false;
    ...
    it('hidden should wait for display: none', async function() {
      let divHidden = false;
      await page.setContent(`<div style='display: block;'></div>`);
      const waitForSelector = page.waitForSelector('div', {hidden: true}).then(() => divHidden = true);
      await page.waitForSelector('div'); // do a round trip
    ...
    it('hidden should wait for removal', async function() {
    ...
    it('should respect timeout', async function() {
      let error = null;
    ...
    it('should respond to node attribute mutation', async function() {
      let divFound = false;
  ...
  describe('Page.waitFor', function() {
    it('should wait for selector', async function() {
      let found = false;
    ...
    it('should wait for predicate', async function() {
      const watchdog = page.waitFor(() => window.innerWidth < 100);
      page.setViewport({width: 10, height: 10});
      await watchdog;
    });
    it('should throw when unknown type', async function() {
      let error = null;
      await page.waitFor({foo: 'bar'}).catch(e => error = e);
      expect(error.message).toContain('Unsupported target type');
    });
    it('should wait for predicate with arguments', async function() {
  ...
  describe('Page.Events.Console', function() {
    ...
    it('should work for different console API calls', async function() {
      const messages = [];
    ...
    it('should not fail for window object', async function() {
      let message = null;
  ...
  describe('Page.metrics', function() {
    it('should get metrics from a page', async function() {
      await page.goto('about:blank');
      const metrics = await page.metrics();
      checkMetrics(metrics);
    });
    it('metrics event fired on console.timeStamp', async function() {
  ...
  describe('Page.goto', function() {
    it('should navigate to about:blank', async function() {
      const response = await page.goto('about:blank');
      expect(response).toBe(null);
    });
    it('should navigate to empty page with domcontentloaded', async function() {
      const response = await page.goto(EMPTY_PAGE, {waitUntil: 'domcontentloaded'});
      expect(response.status).toBe(200);
    });
    it('should navigate to empty page with networkidle0', async function() {
      const response = await page.goto(EMPTY_PAGE, {waitUntil: 'networkidle0'});
      expect(response.status).toBe(200);
    });
    it('should navigate to empty page with networkidle2', async function() {
      const response = await page.goto(EMPTY_PAGE, {waitUntil: 'networkidle2'});
      expect(response.status).toBe(200);
    });
    it('should fail when navigating to bad url', async function() {
      let error = null;
      await page.goto('asdfasdf').catch(e => error = e);
      expect(error.message).toContain('Cannot navigate to invalid URL');
    });
    it('should fail when navigating to bad SSL', async function() {
    ...
    it('should fail when navigating to bad SSL after redirects', async function() {
    ...
    it('should throw if networkidle is passed as an option', async function() {
      let error = null;
    ...
    it('should fail when main resources failed to load', async function() {
      let error = null;
      await page.goto('http://localhost:44123/non-existing-url').catch(e => error = e);
      expect(error.message).toContain('net::ERR_CONNECTION_REFUSED');
    });
    it('should fail when exceeding maximum navigation timeout', async function() {
    ...
    it('should disable timeout when its set to 0', async function() {
      let error = null;
      let loaded = false;
    ...
    it('should work when navigating to valid url', async function() {
      const response = await page.goto(EMPTY_PAGE);
      expect(response.ok).toBe(true);
    });
    it('should work when navigating to data url', async function() {
      const response = await page.goto('data:text/html,hello');
      expect(response.ok).toBe(true);
    });
    it('should work when navigating to 404', async function() {
      const response = await page.goto(PREFIX + '/not-found');
      expect(response.ok).toBe(false);
      expect(response.status).toBe(404);
    });
    it('should return last response in redirect chain', async function() {
      server.setRedirect('/redirect/1.html', '/redirect/2.html');
    ...
    it('should wait for network idle to succeed navigation', async function() {
      let responses = [];
    ...
    it('should navigate to dataURL and fire dataURL requests', async function() {
      const requests = [];
    ...
    it('should navigate to URL with hash and fire requests without hash', async function() {
      const requests = [];
      page.on('request', request => requests.push(request));
  ...
  describe('Page.waitForNavigation', function() {
    ...
    it('should work with both domcontentloaded and load', async function() {
      let response = null;
  ...
  describe('Page.exposeFunction', function() {
    ...
    it('should survive navigation', async function() {
      await page.exposeFunction('compute', function(a, b) {
        return a * b;
      });
    ...
    it('should await returned promise', async function() {
      await page.exposeFunction('compute', function(a, b) {
    ...
    it('should work on frames', async function() {
      await page.exposeFunction('compute', function(a, b) {
        return Promise.resolve(a * b);
      });
    ...
    it('should work on frames before navigation', async function() {
      await page.goto(PREFIX + '/frames/nested-frames.html');
      await page.exposeFunction('compute', function(a, b) {
        return Promise.resolve(a * b);
      });
  ...
  describe('Page.setRequestInterception', function() {
    ...
    it('should stop intercepting', async function() {
      await page.setRequestInterception(true);
    ...
    it('should show custom HTTP headers', async function() {
    ...
    it('should be abortable with custom error codes', async function() {
      await page.setRequestInterception(true);
      page.on('request', request => {
    ...
    it('should amend HTTP headers', async function() {
      await page.setRequestInterception(true);
      page.on('request', request => {
    ...
    it('should fail navigation when aborting main resource', async function() {
      await page.setRequestInterception(true);
    ...
    it('should work with redirects', async function() {
      await page.setRequestInterception(true);
      const requests = [];
      page.on('request', request => {
        request.continue();
    ...
    it('should be able to abort redirects', async function() {
      await page.setRequestInterception(true);
    ...
    it('should work with equal requests', async function() {
      await page.goto(EMPTY_PAGE);
      let responseCount = 1;
    ...
    it('should abort data URLs', async function() {
      await page.setRequestInterception(true);
      page.on('request', request => {
        request.abort();
      });
    ...
    it('should navigate to URL with hash and and fire requests without hash', async function() {
      await page.setRequestInterception(true);
      const requests = [];
      page.on('request', request => {
        requests.push(request);
    ...
    it('should work with encoded URLs', async function() {
    ...
    it('should work with badly encoded URLs', async function() {
      await page.setRequestInterception(true);
    ...
    it('should work with encoded URLs - 2', async function() {
    ...
    it('should not throw "Invalid Interception Id" if the request was cancelled', async function() {
    ...
    it('should throw if interception is not enabled', async function() {
      let error = null;
  ...
  describe('Request.respond', function() {
    ...
    it('should allow mocking binary responses', async function() {
      await page.setRequestInterception(true);
      page.on('request', request => {
  ...
  describe('Page.Events.Dialog', function() {
    ...
    it('should allow accepting prompts', async function() {
      page.on('dialog', dialog => {
    ...
    it('should dismiss the prompt', async function() {
      page.on('dialog', dialog => {
        dialog.dismiss();
      });
  ...
  describe('Frame Management', function() {
    ...
    it('should send events when frames are manipulated dynamically', async function() {
      await page.goto(EMPTY_PAGE);
    ...
    it('should persist mainFrame on cross-process navigation', async function() {
      await page.goto(EMPTY_PAGE);
      const mainFrame = page.mainFrame();
      await page.goto('http://127.0.0.1:' + PORT + '/empty.html');
      expect(page.mainFrame() === mainFrame).toBeTruthy();
    });
    it('should not send attach/detach events for main frame', async function() {
      let hasEvents = false;
    ...
    it('should detach child frames on navigation', async function() {
      let attachedFrames = [];
      let detachedFrames = [];
      let navigatedFrames = [];
      page.on('frameattached', frame => attachedFrames.push(frame));
    ...
    it('should report frame.name()', async function() {
    ...
    it('should report frame.parent()', async function() {
      await FrameUtils.attachFrame(page, 'frame1', EMPTY_PAGE);
      await FrameUtils.attachFrame(page, 'frame2', EMPTY_PAGE);
  ...
  describe('Page.$eval', function() {
    ...
    it('should accept ElementHandles as arguments', async function() {
      await page.setContent('<section>hello</section><div> world</div>');
      const divHandle = await page.$('div');
      const text = await page.$eval('section', (e, div) => e.textContent + div.textContent, divHandle);
      expect(text).toBe('hello world');
    });
    it('should throw error if no element is found', async function() {
      let error = null;
  ...
  describe('Page.$', function() {
    it('should query existing element', async function() {
      await page.setContent('<section>test</section>');
      const element = await page.$('section');
      expect(element).toBeTruthy();
    });
    it('should return null for non-existing element', async function() {
  ...
  describe('Page.$$', function() {
    it('should query existing elements', async function() {
    ...
    it('should return empty array if nothing is found', async function() {
      await page.goto(EMPTY_PAGE);
      const elements = await page.$$('div');
  ...
  describe('ElementHandle.boundingBox', function() {
    ...
    it('should return null for invisible elements', async function() {
  ...
  describe('ElementHandle.click', function() {
    ...
    it('should work for Shadow DOM v1', async function() {
    ...
    it('should work for TextNodes', async function() {
      await page.goto(PREFIX + '/input/button.html');
    ...
    it('should throw for detached nodes', async function() {
      await page.goto(PREFIX + '/input/button.html');
      const button = await page.$('button');
    ...
    it('should throw for hidden nodes', async function() {
      await page.goto(PREFIX + '/input/button.html');
      const button = await page.$('button');
    ...
    it('should throw for recursively hidden nodes', async function() {
      await page.goto(PREFIX + '/input/button.html');
      const button = await page.$('button');
    ...
    it('should throw for <br> elements', async function() {
  ...
  describe('ElementHandle.screenshot', function() {
    ...
    it('should take into account padding and border', async function() {
      await page.setViewport({width: 500, height: 500});
    ...
    it('should work with a rotated element', async function() {
      await page.setViewport({width: 500, height: 500});
    ...
    it('should fail to screenshot a detached element', async function() {
  ...
  describe('ElementHandle.$$', function() {
    ...
    it('should return empty array for non-existing elements', async function() {
  ...
  describe('input', function() {
    ...
    it('should click on checkbox input and toggle', async function() {
    ...
    it('should click on checkbox label and toggle', async function() {
      await page.goto(PREFIX + '/input/checkbox.html');
      expect(await page.evaluate(() => result.check)).toBe(null);
    ...
    it('should fail to click a missing button', async function() {
      await page.goto(PREFIX + '/input/button.html');
      let error = null;
    ...
    it('should not hang with touch-enabled viewports', async function() {
      await page.setViewport(iPhone.viewport);
      await page.mouse.down();
      await page.mouse.move(100, 10);
      await page.mouse.up();
    });
    it('should type into the textarea', async function() {
    ...
    it('should click the button after navigation ', async function() {
      await page.goto(PREFIX + '/input/button.html');
      await page.click('button');
      await page.goto(PREFIX + '/input/button.html');
      await page.click('button');
    ...
    it('should move with the arrow keys', async function(){
      await page.goto(PREFIX + '/input/textarea.html');
    ...
    it('should send a character with ElementHandle.press', async function() {
      await page.goto(PREFIX + '/input/textarea.html');
      const textarea = await page.$('textarea');
    ...
    it('should send a character with sendCharacter', async function() {
      await page.goto(PREFIX + '/input/textarea.html');
    ...
    it('should report shiftKey', async function(){
    ...
    it('should report multiple modifiers', async function(){
      await page.goto(PREFIX + '/input/keyboard.html');
      const keyboard = page.keyboard;
    ...
    it('should send proper codes while typing', async function(){
      await page.goto(PREFIX + '/input/keyboard.html');
    ...
    it('should send proper codes while typing with shift', async function(){
      await page.goto(PREFIX + '/input/keyboard.html');
      const keyboard = page.keyboard;
    ...
    it('should not type canceled events', async function(){
      await page.goto(PREFIX + '/input/textarea.html');
      await page.focus('textarea');
      await page.evaluate(() => {
    ...
    it('keyboard.modifiers()', async function(){
      const keyboard = page.keyboard;
    ...
    it('should resize the textarea', async function(){
      await page.goto(PREFIX + '/input/textarea.html');
    ...
    it('should scroll and click the button', async function(){
      await page.goto(PREFIX + '/input/scrollable.html');
    ...
    it('should click a partially obscured button', async function() {
      await page.goto(PREFIX + '/input/button.html');
      await page.evaluate(() => {
    ...
    it('should select the text with mouse', async function(){
      await page.goto(PREFIX + '/input/textarea.html');
      await page.focus('textarea');
    ...
    it('should select the text by triple clicking', async function(){
      await page.goto(PREFIX + '/input/textarea.html');
      await page.focus('textarea');
      const text = 'This is the text that we are going to try to select. Let\'s see how it goes.';
      await page.keyboard.type(text);
    ...
    it('should trigger hover state', async function(){
      await page.goto(PREFIX + '/input/scrollable.html');
    ...
    it('should fire contextmenu event on right click', async function(){
      await page.goto(PREFIX + '/input/scrollable.html');
      await page.click('#button-8', {button: 'right'});
      expect(await page.evaluate(() => document.querySelector('#button-8').textContent)).toBe('context menu');
    });
    it('should set modifier keys on click', async function(){
      await page.goto(PREFIX + '/input/scrollable.html');
    ...
    it('should specify repeat property', async function(){
      await page.goto(PREFIX + '/input/textarea.html');
      await page.focus('textarea');
    ...
    it('should click links which cause navigation', async function() {
      await page.setContent(`<a href="${EMPTY_PAGE}">empty.html</a>`);
      // This await should not hang.
      await page.click('a');
    });
    it('should tween mouse movement', async function() {
      await page.mouse.move(100, 100);
      await page.evaluate(() => {
        window.result = [];
    ...
    it('should tap the button', async function() {
      await page.goto(PREFIX + '/input/button.html');
      await page.tap('button');
      expect(await page.evaluate(() => result)).toBe('Clicked');
    });
    xit('should report touches', async function() {
      await page.goto(PREFIX + '/input/touches.html');
      const button = await page.$('button');
      await button.tap();
      expect(await page.evaluate(() => getResult())).toEqual(['Touchstart: 0', 'Touchend: 0']);
    });
    it('should click the button inside an iframe', async function() {
      await page.goto(EMPTY_PAGE);
    ...
    it('should click the button with deviceScaleFactor set', async function() {
    ...
    it('should type all kinds of characters', async function() {
      await page.goto(PREFIX + '/input/textarea.html');
      await page.focus('textarea');
    ...
    it('should specify location', async function() {
      await page.goto(PREFIX + '/input/textarea.html');
      await page.evaluate(() => {
  ...
  describe('Page.setUserAgent', function() {
    ...
    it('should emulate device user-agent', async function() {
  ...
  describe('Page.setExtraHTTPHeaders', function() {
    ...
    it('should throw for non-string header values', async function() {
      let error = null;
      try {
  ...
  describe('Page.authenticate', function() {
    ...
    it('should fail if wrong credentials', async function() {
    ...
    it('should allow disable authentication', async function() {
      // Use unique user/password since Chrome caches credentials per origin.
  ...
  describe('Page.setContent', function() {
    ...
    it('should work with doctype', async function() {
      const doctype = '<!DOCTYPE html>';
      await page.setContent(`${doctype}<div>hello</div>`);
      const result = await page.content();
      expect(result).toBe(`${doctype}${expectedOutput}`);
    });
    it('should work with HTML 4 doctype', async function() {
  ...
  describe('Network Events', function() {
    it('Page.Events.Request', async function() {
      const requests = [];
      page.on('request', request => requests.push(request));
      await page.goto(EMPTY_PAGE);
      expect(requests.length).toBe(1);
    ...
    it('Page.Events.Request should report post data', async function() {
      await page.goto(EMPTY_PAGE);
    ...
    it('Page.Events.Response', async function() {
      const responses = [];
    ...
    it('Page.Events.Response should provide body', async function() {
      let response = null;
    ...
    it('Page.Events.Response should not report body unless request is finished', async() => {
      await page.goto(EMPTY_PAGE);
    ...
    it('Page.Events.RequestFailed', async function() {
      await page.setRequestInterception(true);
      page.on('request', request => {
        if (request.url.endsWith('css'))
          request.abort();
    ...
    it('Page.Events.RequestFinished', async function() {
      const requests = [];
    ...
    it('should fire events in proper order', async function() {
      const events = [];
  ...
  describe('Page.addScriptTag', function() {
    ...
    it('should throw an error if loading from url fail', async function() {
      await page.goto(EMPTY_PAGE);
      let error = null;
      try {
    ...
    it('should work with a path', async function() {
      await page.goto(EMPTY_PAGE);
    ...
    it('should include sourcemap when path is provided', async function() {
      await page.goto(EMPTY_PAGE);
    ...
    it('should work with content', async function() {
      await page.goto(EMPTY_PAGE);
  ...
  describe('Page.viewport', function() {
    ...
    it('should support touch emulation', async function() {
      await page.goto(PREFIX + '/mobile.html');
    ...
    it('should be detectable by Modernizr', async function(){
    ...
    it('should support landscape emulation', async function() {
      await page.goto(PREFIX + '/mobile.html');
  ...
  describe('Page.emulate', function() {
    ...
    it('should support clicking', async function() {
      await page.emulate(iPhone);
      await page.goto(PREFIX + '/input/button.html');
      const button = await page.$('button');
  ...
  describe('Page.emulateMedia', function() {
    ...
    it('should throw in case of bad argument', async function() {
      let error = null;
  ...
  describe('Page.evaluateOnNewDocument', function() {
    it('should evaluate before anything else on the page', async function() {
      await page.evaluateOnNewDocument(function(){
        window.injected = 123;
      });
  ...
  (headless ? describe : xdescribe)('Page.pdf', function() {
    it('should be able to save file', async function() {
      const outputFile = __dirname + '/assets/output.pdf';
      await page.pdf({path: outputFile});
      expect(fs.readFileSync(outputFile).byteLength).toBeGreaterThan(0);
      fs.unlinkSync(outputFile);
    });
    it('should default to printing in Letter format', async function() {
    ...
    it('should support setting custom format', async function() {
      const pages = await getPDFPages(await page.pdf({
        format: 'a4'
      }));
      expect(pages.length).toBe(1);
    ...
    it('should support setting paper width and height', async function() {
      const pages = await getPDFPages(await page.pdf({
        width: '10in',
        height: '10in',
      }));
    ...
    it('should print multiple pages', async function() {
      await page.goto(PREFIX + '/grid.html');
    ...
    it('should support page ranges', async function() {
      await page.goto(PREFIX + '/grid.html');
      // Define width and height in CSS pixels.
      const width = 50 * 5 + 1;
      const height = 50 * 5 + 1;
    ...
    it('should throw if format is unknown', async function() {
      let error = null;
      try {
    ...
    it('should throw if units are unknown', async function() {
      let error = null;
      try {
        await getPDFPages(await page.pdf({
          width: '10em',
  ...
  describe('Page.title', function() {
    it('should return the page title', async function(){
      await page.goto(PREFIX + '/input/button.html');
  ...
  describe('Page.screenshot', function() {
    ...
    it('should clip rect', async function() {
      await page.setViewport({width: 500, height: 500});
      await page.goto(PREFIX + '/grid.html');
      const screenshot = await page.screenshot({
        clip: {
    ...
    it('should work for offscreen clip', async function() {
      await page.setViewport({width: 500, height: 500});
      await page.goto(PREFIX + '/grid.html');
      const screenshot = await page.screenshot({
        clip: {
    ...
    it('should take fullPage screenshots', async function() {
      await page.setViewport({width: 500, height: 500});
      await page.goto(PREFIX + '/grid.html');
      const screenshot = await page.screenshot({
        fullPage: true
    ...
    it('should run in parallel in multiple pages', async function() {
      const N = 2;
    ...
    it('should allow transparency', async function() {
      await page.setViewport({ width: 100, height: 100 });
      await page.goto(EMPTY_PAGE);
      const screenshot = await page.screenshot({omitBackground: true});
      expect(screenshot).toBeGolden('transparent.png');
    });
    it('should work with odd clip size on Retina displays', async function() {
      const screenshot = await page.screenshot({
        clip: {
          x: 0,
          y: 0,
  ...
  describe('Page.select', function() {
    it('should select single option', async function() {
    ...
    it('should respect event bubbling', async function() {
      await page.goto(PREFIX + '/input/select.html');
      await page.select('select', 'blue');
    ...
    it('should throw when element is not a <select>', async function() {
      let error = null;
      await page.goto(PREFIX + '/input/select.html');
      await page.select('body', '').catch(e => error = e);
      expect(error.message).toContain('Element is not a <select> element.');
    });
    it('should return [] on no matched values', async function() {
      await page.goto(PREFIX + '/input/select.html');
      const result = await page.select('select','42','abc');
      expect(result).toEqual([]);
    });
    it('should return an array of matched values', async function() {
      await page.goto(PREFIX + '/input/select.html');
      await page.evaluate(() => makeMultiple());
    ...
    it('should return an array of one element when multiple is not set', async function() {
      await page.goto(PREFIX + '/input/select.html');
      const result = await page.select('select','42','blue','black','magenta');
      expect(result.length).toEqual(1);
    });
    it('should return [] on no values',async function() {
      await page.goto(PREFIX + '/input/select.html');
      const result = await page.select('select');
      expect(result).toEqual([]);
    });
    it('should deselect all options when passed no values for a multiple select',async function() {
      await page.goto(PREFIX + '/input/select.html');
      await page.evaluate(() => makeMultiple());
    ...
    it('should deselect all options when passed no values for a select without multiple',async function() {
      await page.goto(PREFIX + '/input/select.html');
      await page.select('select','blue','black','magenta');
      await page.select('select');
      expect(await page.$eval('select', select => Array.from(select.options).every(option => !option.selected))).toEqual(true);
    });
    it('should throw if passed in non-strings', async function() {
  ...
  describe('Tracing', function() {
    ...
    it('should output a trace', async function() {
      await page.tracing.start({screenshots: true, path: outputFile});
      await page.goto(PREFIX + '/grid.html');
      await page.tracing.stop();
      expect(fs.existsSync(outputFile)).toBe(true);
    });
    it('should run with custom categories if provided', async function() {
    ...
    it('should throw if tracing on two pages', async function() {
  ...
  describe('Cookies', function() {
    ...
    it('should set and get cookies', async function(){
      await page.goto(PREFIX + '/grid.html');
    ...
    it('should set a cookie with a path', async function(){
      await page.goto(PREFIX + '/grid.html');
      await page.setCookie({
        name: 'gridcookie',
        value: 'GRID',
    ...
    it('should delete a cookie', async function(){
      await page.goto(PREFIX + '/grid.html');
      await page.setCookie({
        name: 'cookie1',
        value: '1'
    ...
    it('should set a cookie on a different domain', async function() {
      await page.goto(PREFIX + '/grid.html');
    ...
    it('should set cookies from a frame', async function() {
      await page.goto(PREFIX + '/grid.html');
  ...
  describe('Target', function() {
    it('Browser.targets should return all of the targets', async function() {
    ...
    it('Browser.pages should return all of the pages', async function() {
      // The pages will be the testing page and the original newtab page
    ...
    it('should be able to use the default page in the browser', async function() {
      // The pages will be the testing page and the original newtab page
      const allPages = await browser.pages();
    ...
    it('should report when a new page is created and closed', async function(){
    ...
    it('should report when a service worker is created and destroyed', async function() {
      await page.goto(EMPTY_PAGE);
    ...
    it('should report when a target url changes', async function(){
      await page.goto(EMPTY_PAGE);
    ...
    it('should not report uninitialized pages', async function() {
    ...
    it('should not crash while redirecting if original request was missed', async function() {
      let serverResponse = null;
  ...
  describe('Connection', function() {
    it('should throw nice errors', async function() {
...
if (process.env.COVERAGE) {
  describe('COVERAGE', function(){
    ...
    for (const method of coverage.keys()) {
      (disabled.has(method) ? xit : it)(`public api '${method}' should be called`, async function(){
