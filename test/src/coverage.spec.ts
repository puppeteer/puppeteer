...
describe('Coverage specs', function () {
  ...
  describe('JSCoverage', function () {
    ...
    describe('resetOnNavigation', function () {
      // With RenderDocument in Chrome, coverage is not carried over
      // between navigations making resetOnNavigation useless.
      it('should NOT report scripts across navigations when disabled', async () => {
        const {page, server} = await getTestState();
